...
class NetworkService():
    ...
    def get_private_subnet_01(stack):
        ...
        private_subnet_resource_01 = aws_ec2.Subnet.from_subnet_attributes(
            ...
            subnet_id=CdkConfig.config['network_resources']['private_subnet']['subnet_resource_01']\
                ['subnet_id']
        )
    ...
    def get_private_subnet_02(stack):
        ...
        private_subnet_resource_02 = aws_ec2.Subnet.from_subnet_attributes(
            ...
            subnet_id=CdkConfig.config['network_resources']['private_subnet']['subnet_resource_02']\
                ['subnet_id']
        )
    ...
    def private_subnet_selection(stack):
        ...
        private_subnets = aws_ec2.SubnetSelection(
            subnets=[NetworkService.get_private_subnet_01(stack), \
                NetworkService.get_private_subnet_02(stack)],
        )
    ...
    def get_public_subnet_01(stack):
        ...
        public_subnet_resource_01 = aws_ec2.Subnet.from_subnet_attributes(
            ...
            subnet_id=CdkConfig.config['network_resources']['public_subnet']['subnet_resource_01']\
                ['subnet_id']
        )
    ...
    def get_public_subnet_02(stack):
        ...
        public_subnet_resource_02 = aws_ec2.Subnet.from_subnet_attributes(
            ...
            subnet_id=CdkConfig.config['network_resources']['public_subnet']['subnet_resource_02']\
                ['subnet_id']
        )
    ...
    def public_subnet_selection(stack):
        ...
        public_subnets = aws_ec2.SubnetSelection(
            subnets=[NetworkService.get_public_subnet_01(stack), \
                NetworkService.get_public_subnet_02(stack)],
        )
        return public_subnets

    def create_alb_security_group(stack, vpc):    #pylint: disable=E0213
